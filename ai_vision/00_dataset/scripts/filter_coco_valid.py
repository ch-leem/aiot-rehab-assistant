...
if __name__ == "__main__":
    COCO_JSON = "annotations_trainval2017/annotations/person_keypoints_val2017.json"
    IMAGE_ROOT = "val2017/"
    ...
    with open("outputs/coco_val_pose_candidates.json", "w") as f:
        json.dump(results, f, indent=2)

    # OpenPose 입력용 txt
    with open("outputs/coco_val_image_list.txt", "w") as f:
        for r in results:
            f.write(os.path.join(IMAGE_ROOT, r["file_name"]) + "\n")

    print("✔ coco_val_pose_candidates.json 생성 완료")
    print("✔ coco_val_image_list.txt 생성 완료")
